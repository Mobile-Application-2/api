  ...
  try {
    ...
    await session.withTransaction(async session => {
      try {
        ...
        // TODO: recipient is not online (for the web version no push notifications yet)
        ...
        // socket has disconnected but it just hasn't reflected on redis (for the web version no push notifications yet)
